...
//  var outputHeight = params.outputHeight || '50px'; // optional parameter
  var outputHeight = '500px'; // optional parameter
  ...
  domRoot.append(
      '<p/><textarea style="width: 1200px; height: ' + outputHeight + ';" ' +
...
function renderAssessment(assessment, domRoot) {
  ...
  $.each(assessment.questionsList, function(questionNum, q) {
    ...
    if (q.choices) {
      ...
      curLI.append('&nbsp;&nbsp;<textarea cols="20" wrap="soft" class="alphanumericOnly" ' +
          'style="width: 600px; height: 150px; border-style: solid; border-color: black; border-width: 1px;" ' +
          'id="q' + questionNum + '">');
    } else {
